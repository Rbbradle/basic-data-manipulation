...
#get qdap package to load correctly then try the below
#phil <- c('phillips','phlips', 'phllips','phillps','fillips') -- get this to work
#gsub(phil, 'philips',refine$company)

refine$company <- gsub('phlips', 'philips', gsub('fillips', 'philips, gsub('phillips', 'philips', gsub('phllips', 'philips', gsub(0, 'o', gsub(' ', '', gsub('phillps', 'philips', tolower(refine$company))))))))
